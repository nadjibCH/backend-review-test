...
class GitHubArchiveStreamerTest extends TestCase
{
    ...
    public function testItShouldGenerateCorrectArchiveUrl(): void
    {
    ...
    public function testItShouldStreamAndParseGithubArchive(): void
    {
    ...
    public function testItShouldThrowExceptionOnTransportError(): void
    {
        $url = 'https://data.gharchive.org/2023-01-01-5.json.gz';
